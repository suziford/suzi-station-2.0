...
namespace Content.Shared.Atmos.EntitySystems
{
    public abstract class SharedGasTileOverlaySystem : EntitySystem
    {
        ...
        public readonly struct GasOverlayData : IEquatable<GasOverlayData>
        {
            ...
            [ViewVariables] public readonly byte FireType; // <Onyx>
            ...
            /// </summary>
            [ViewVariables]
            public readonly ThermalByte ByteGasTemperature; // <Onyx>
            ...
            public GasOverlayData(byte fireState, byte[] opacity, ThermalByte byteTemp, byte type) // <Onyx-edited>
            {
                FireState = fireState;
                Opacity = opacity;
                ByteGasTemperature = byteTemp; // <Onyx>
                FireType = type; // <Onyx>
            }
